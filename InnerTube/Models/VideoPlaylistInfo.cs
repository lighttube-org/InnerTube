...
public class VideoPlaylistInfo(Playlist playlist, string parserLanguage)
{
	...
	public IEnumerable<RendererContainer> Videos { get; } = Utils.ConvertRenderers(playlist.Contents, parserLanguage);
}